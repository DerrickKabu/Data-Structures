...
print('(a.(i))' + 'The bending moment at x=0 is: ' + str(M) + ' and ' + 'the shear force at x=0 is: ' + str(V))
...
print()
print('(a.(ii))' + 'The bending moment at x=12 is: ' + str(m) + ' and ' + 'the shear force at x=12 is: ' + str(v))
